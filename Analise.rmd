...
dados_sample <- read.delim("C:/x/x/x/data_clinical_sample.txt", header = TRUE, stringsAsFactors = FALSE)
dados_patient <- read.delim("C:/x/x/x/data_clinical_patient.txt", header = TRUE, stringsAsFactors = FALSE)
